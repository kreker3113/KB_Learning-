...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KoinComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>navigation</b> with <b>io.insert-koin:koin-compose-viewmodel-navigation</b> coordinates and
         * with version reference <b>koin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNavigation() {
            return create("koin.compose.navigation");
        }
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>kotlin.date</b>
         */
    ...
    public static class KotlinDateLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>time</b> with <b>org.jetbrains.kotlinx:kotlinx-datetime</b> coordinates and
         * with version reference <b>kotlin.date.time</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class TestLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>assertk</b> with <b>com.willowtreeapps.assertk:assertk</b> coordinates and
         * with version reference <b>assertK</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAssertk() {
            return create("test.assertk");
        }
        ...
        /**
         * Group of libraries at <b>test.compose</b>
         */
        ...
        /**
         * Group of libraries at <b>test.core</b>
         */
        public TestCoreLibraryAccessors getCore() {
            return laccForTestCoreLibraryAccessors;
        }
    ...
    public static class TestComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>compose.test</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getManifest() {
            return create("test.compose.manifest");
        }

        /**
         * Group of libraries at <b>test.compose.ui</b>
         */
        public TestComposeUiLibraryAccessors getUi() {
            return laccForTestComposeUiLibraryAccessors;
        }

    }

    public static class TestComposeUiLibraryAccessors extends SubDependencyFactory {
        private final TestComposeUiJunit4LibraryAccessors laccForTestComposeUiJunit4LibraryAccessors = new TestComposeUiJunit4LibraryAccessors(owner);

        public TestComposeUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>test.compose.ui.junit4</b>
         */
        public TestComposeUiJunit4LibraryAccessors getJunit4() {
            return laccForTestComposeUiJunit4LibraryAccessors;
        }

    }

    public static class TestComposeUiJunit4LibraryAccessors extends SubDependencyFactory {

        public TestComposeUiJunit4LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("test.compose.ui.junit4.android");
        }

    }

    public static class TestCoreLibraryAccessors extends SubDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>assertK</b> with value <b>0.25</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBiometry() { return getVersion("biometry"); }
        ...
        /**
         * Version alias <b>room</b> with value <b>2.7.0-alpha11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>turbine</b> with value <b>0.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class CoilVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coil.compose</b> with value <b>3.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.test</b> with value <b>1.7.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTest() { return getVersion("compose.test"); }
    ...
    public static class CoreVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>core.ktx</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Group of versions at <b>versions.kotlin.date</b>
         */
    ...
    public static class KotlinDateVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlin.date.time</b> with value <b>0.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTime() { return getVersion("kotlin.date.time"); }
    ...
    public static class KotlinxCoroutinesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.coroutines.test</b> with value <b>1.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
