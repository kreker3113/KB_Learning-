Executing tasks: [:composeApp:extractApksForDebug] in project /home/aleksey/KB_Learning
...
* Where:
Build file '/home/aleksey/KB_Learning/server/build.gradle.kts' line: 1
...
* Exception is:
org.gradle.api.GradleException: Error resolving plugin [id: 'org.jetbrains.kotlin.jvm', version: '2.0.21']
...
Caused by: org.gradle.plugin.management.internal.InvalidPluginRequestException: The request for this plugin could not be satisfied because the plugin is already on the classpath with an unknown version, so compatibility cannot be checked.
	...
	at org.gradle.plugin.use.internal.DefaultPluginRequestApplicator.resolvePluginRequest(DefaultPluginRequestApplicator.java:185)
	... 167 more
